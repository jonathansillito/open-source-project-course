...
* For each of your contributions (possibly grouped in some way) describe
    * The contribution, why it is meaningful to the project, and why you selected it.
    * The engineering work involved, including a link to the contribution itself (pull requests, commits, triage work, etc.). Please provide relevant details about your design and implementation choices.
