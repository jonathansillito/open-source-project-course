...
* First, we will discuss a general process call the <course-link type="page" id="P_CPS">Osborn-Parnes Creative Problem-Solving Process (CPS)</course-link>
* Second, we will focus on using the process in a <course-link type="page" id="P_Engineering">software engineering context</course-link>
